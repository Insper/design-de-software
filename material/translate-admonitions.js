...
/* Substituindo tags */
let admonition_titles = document.querySelectorAll(".admonition h3");
admonition_titles.forEach(function (title) {
    titleClasses = title.getAttribute("class");
    if (titleClasses == null) titleClasses = "";
    titleClasses += " admonition-title";
    title.setAttribute("class", titleClasses);
});
